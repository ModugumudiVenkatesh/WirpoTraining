          ...
          //  unsafe
            {
              //  int number = 456;
                ...
                Console.WriteLine($"sub of 2 numbers : {a - b}");
                Console.WriteLine($"Mul of 2 numbers : {a * b}");
                Console.WriteLine($"Divi of 2 numbers : {a / b}");
                Console.WriteLine($"Mod of 2 numbers : {a % b}");
                Console.ReadKey();
            }
        }
